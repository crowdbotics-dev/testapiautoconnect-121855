...
## Project Structure
    ...
    ├── testapiautoconnect_121855  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_121855`
...
2. Clone this repo and `cd testapiautoconnect_121855`
